...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Список проектов"))

        self.pushButton_4.setText(_translate("MainWindow", "Назад"))
        
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Код проекта"))
        ...
        item.setText(_translate("MainWindow", "Кода работника"))
